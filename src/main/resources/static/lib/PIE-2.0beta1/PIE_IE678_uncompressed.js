...
PIE.BoundsInfo.prototype = {
     ...
     * this does a simple getBoundingClientRect comparison for detecting the
...
PIE.merge(PIE.RendererBase, {
    ...
    hideBorder: function() {
        ...
        if( ( isIE6 && ( tag in PIE.childlessElements || tag === 'FIELDSET' ) ) ||
            ...
            // find a better way to do this that doesn't mess up the DOM parent-child relationship,
...
PIE.BorderImageRenderer = PIE.RendererBase.newRenderer( {
    ...
    draw: function() {
        ...
        PIE.Util.withImageSize( props.src, function( imgSize ) {
            ...
            // right now this treats everything like 'stretch', need to support other schemes
            ...
            if( !initialized ) {
                ...
                if( lazy && ( bounds = boundsInfo.getBounds() ) && ( docEl = doc.documentElement || doc.body ) &&
                    ...
                    if ( ieDocMode === 9 ) {
                        ...
                        rootRenderer.childRenderers = childRenderers; // circular reference, can't pass in constructor; is there a cleaner way?
                    }
